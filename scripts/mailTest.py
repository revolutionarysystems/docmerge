...
from merge.merge_utils import email_file



def xemailDoc(baseFileName, me, you, subject, credentials):
...
print(email_file("..\merge\output\Simple_001", "fake@fake.com", "andrew.elliott@revolutionarysystems.co.uk", "Your Tenancy", credentials))
